...
# Go 1.27 is currently incompatible with sing-box's go-json-experiment dependency.
git clone --branch 26.x --single-branch https://github.com/sbwml/packages_lang_golang feeds/packages/lang/golang
